...
from sdk.common.utils.inject import InjectorException
...
class TestInjectConfiguration(BaseTestInject):
    ...
    def test_configure__already_configured(self):
        ...
        self.assertRaisesRegexp(
            InjectorException, "Injector is already configured", inject.configure
        )
    ...
    def test_get_injector_or_die(self):
        self.assertRaisesRegexp(
            InjectorException, "No injector is configured", inject.get_injector_or_die
        )
