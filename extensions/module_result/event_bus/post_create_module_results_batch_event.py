...
class PostCreateModuleResultBatchEvent(BaseEvent, Convertible):

    def __init__(self, primitives, user_id, module_id, module_result_id,
                 module_config_id, deployment_id, device_name, start_date_time):
